...
CREATE DATABASE IF NOT EXISTS text01_office;

ALTER DATABASE text01_office CHARACTER SET utf8;
...
c_city varchar(50) c_birth date
*/
...
CHANGE mibile mobile VARCHAR(25);
